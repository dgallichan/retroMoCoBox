function [grappaRecon_1DFFT, mOutGRAPPA] = performHostGRAPPArecon2D_RAMonly(twix_obj, counterStruct, nSliceNeighbours, combinePars)
%
% function [grappaRecon_1DFFT, mOutGRAPPA] = performHostGRAPPArecon2D_RAMonly(twix_obj, counterStruct, nSliceNeighbours, combinePars))
%
% Applies GRAPPA to the host data, which here is assumed to be accelerated
% on both PE directions (not currently possible with Siemens MP2RAGE pulse
% sequence!).
%
