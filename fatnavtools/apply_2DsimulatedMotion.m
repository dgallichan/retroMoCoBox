...
[~, st] = applyRetroMC_nufft_2D(kdata_in, alignMats_swapTrans, alignDim, alignIndices, useTable, dataDims_mm, fullMatrixDims, kspaceCentre);
...
[~,~,kdata_simMotion] = applyRetroMC_nufft_2D(kdata_simRotOnly,alignMats_swapTrans,alignDim,alignIndices,useTable,dataDims_mm,fullMatrixDims,kspaceCentre);
