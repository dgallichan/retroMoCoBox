function [im_corrected, st] = apply_2DMotionCorrection(kdata_in,mpars,cgIters,oversampFactor)
...
[im_corrected, st] = applyRetroMC_nufft_2D(kdata_in, alignMats, alignDim, alignIndices, useTable, dataDims_mm, fullMatrixDims, kspaceCentre,cgIters,oversampFactor);
