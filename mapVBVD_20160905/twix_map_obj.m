...
%                     keyboard
                    disp('NaN encountered in block... replaced with zeros..')
                    block(isnan(block)) = 0;
                end
...
%         strcmp(this.dataType,'phasecor') ||
%         strcmp(this.dataType,'phasestab') % danielg - add
%         imageWithRefscan to this list
        if strcmp(this.dataType,'image') || strcmp(this.dataType,'phasecor') || strcmp(this.dataType,'phasestab') || strcmp(this.dataType,'imagewithrefscan')
...
%         if strcmp(this.dataType,'image') ||
%         strcmp(this.dataType,'phasecor') ||
%         strcmp(this.dataType,'phasestab') % danielg
        if strcmp(this.dataType,'image') || strcmp(this.dataType,'phasecor') || strcmp(this.dataType,'phasestab') || strcmp(this.dataType,'imagewithrefscan')
            this.arg.skipToFirstLine = false;
        else
            this.arg.skipToFirstLine = true;
