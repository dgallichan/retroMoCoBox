...
# the _fixUpsideDown.sh script is a modified version of the original to handle
# the upside-down issue with some subjects where the slice orientation was prescribed
...
echo "matlab -nodisplay -nodesktop -nosplash -r \"rawDataFile='${inputfile}';outRoot='${outRoot}';swapDims_xyz = [0 0 0];bKeepGRAPPArecon=0;parpoolSize = 6;script_pwd = '${PWD}';ASPIRE_HOME='${ASPIRE_HOME}';run_SiemensGRErecon_cluster;exit;\"" >> ${tempfile}
echo " "
echo " "
