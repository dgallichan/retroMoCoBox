...
reconstructSiemensGREwithFatNavs_cluster_skipMoCo(rawDataFile,'swapDims_xyz',swapDims_xyz,'CLUSTER_LOG_PATH',CLUSTER_LOG_PATH,'bKeepGRAPPArecon',bKeepGRAPPArecon,'outRoot',outRoot,'ASPIRE_HOME',ASPIRE_HOME,'parpoolSize',parpoolSize);
